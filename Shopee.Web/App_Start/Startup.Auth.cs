...
[assembly: OwinStartup(typeof(Shopee.Web.App_Start.Startup))]

namespace Shopee.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(ShopeeDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<ShopeeDbContext>());
